...
class MLDA(ArrayStepShared):
    ...
    .. code:: ipython
        ...
        ...     step_method = pmx.step_methods.MLDA(
        ...         coarse_models=[coarse_model],
        ...         subsampling_rates=5,
        ...     )
        ...     idata = pm.sample(
        ...         tune=100, draws=500, chains=2,
        ...         step=step_method,
        ...         random_seed=123,
        ...     )
        ...
        if self.num_levels == 2:
            with self.model_below:
                ...
                if self.base_sampler == "Metropolis":
                    ...
                    self.step_method_below = MetropolisMLDA(
                        vars=vars_below,
                    ...
                    self.step_method_below = DEMetropolisZMLDA(
                        vars=vars_below,
                        S=self.base_S,
                        proposal_dist=self.base_proposal_dist,
                        lamb=self.base_lamb,
